package com.example.corekit.widget.statusBar;
...
public class StatusBarUtil {
     ...
     * @param colorId 颜色
     */
    public static void setStatusBarColor(Activity activity, int colorId, boolean ifDark) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            setTranslucentStatus(activity, ifDark);
    ...
    /** 设置状态栏透明 */
    @TargetApi(19)
    public static void setTranslucentStatus(Activity activity, boolean ifDark) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    private void setRootViewFitsSystemWindows(Activity activity, boolean fitSystemWindows) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            System.out.println("wjfLog:" + 0);
            if (winContent.getChildCount() > 0) {
                System.out.println("wjfLog:" + 1);
                ViewGroup rootView = (ViewGroup) winContent.getChildAt(0);
                if (rootView != null) {
                    System.out.println("wjfLog:2" + fitSystemWindows);
