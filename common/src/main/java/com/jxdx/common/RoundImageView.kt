...
import com.example.corekit.widget.help.RoundHelper
import com.example.corekit.widget.help.RoundMethodInterface
...
class RoundImageView@JvmOverloads constructor(
    ...
    defStyleAttr: Int = 0
) : AppCompatImageView(context, attrs, defStyleAttr), RoundMethodInterface {
